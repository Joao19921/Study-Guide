...
CREATE TABLE "categories" (
	...
	"name" text NOT NULL,
	"color" text DEFAULT '#80aeca' NOT NULL,
...
ALTER TABLE "study_sessions" ADD CONSTRAINT "study_sessions_theme_id_themes_id_fk" FOREIGN KEY ("theme_id") REFERENCES "public"."themes"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "themes" ADD CONSTRAINT "themes_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;